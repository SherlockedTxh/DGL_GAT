...
def main(args):
    ...
    test_dataset = amino_acid_dataset.LegacyAcidDataset(mode='test')
    ...
    # save model
    torch.save(model.state_dict(), "/home/a503tongxueheng/DGL_GAT/ppi_1000.pt")
